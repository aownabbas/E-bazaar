          ...
          <div className="w-full h-full flex justify-between items-center">
            <div className="category-and-nav flex xl:space-x-7 space-x-3 items-center">
              <div className="category h-[53px] w-[250px] bg-white px-5 rounded-t-md mt-[6px] relative">
                ...
                <div
                  className="category-dropdown absolute left-0 top-[53px] overflow-hidden d-flex" style={{ height: `${elementsSize}`, width: `${elementsWidthSize}` }}>
                        ...
                        <Link to="/all-products">
                          <div
                            className={`flex justify-between items-center px-5 h-10 bg-white  transition-all duration-300 ease-in-out cursor-pointer text-qblack ${type === 3
                                ...
                                : "hover:bg-qyellow"
                              }`} onMouseOver={handleSubCategoriesOver} onMouseOut={handleSubCategoriesOut}
                          >
                  ...
                  {openSubCategories ?
                  <div style={{ width: "50%", float: "left" }} onMouseOver={handleSubCategoriesOver} onMouseOut={handleSubCategoriesOut}>
                    <ul className="categories-list">
