...
export default function Navbar({ className, type }) {
  ...
  const handleSubCategoriesOver = async (sub_categories) => {
    setWidthSize("500px");
    setOpenSubCategories({ open: true, subCategorieslist: sub_categories });
  };

  const handleSubCategoriesOut = () => {
    setWidthSize("500px");
    setOpenSubCategories({ open: false });
  };
        ...
        <div className="w-full h-full relative">
          <div className="w-full h-full flex justify-between items-center">
            <div className="category-and-nav flex xl:space-x-7 space-x-3 items-center">
              <div className="category h-[53px] w-[250px] bg-white px-5 rounded-t-md mt-[6px] relative">
                <button
                  onClick={handler}
                  type="button"
                ...
                <div
                  className="category-dropdown absolute left-0 top-[53px] overflow-hidden d-flex"
                  style={{
                    height: `${elementsSize}`,
                ...
                >
                          ...
                          <li className="category-item" key={index}>
                            <Link to="/all-products">
                              <div
                                ...
                                onMouseOut={handleSubCategoriesOut}
                              >
                  ...
                  {openSubCategories.open ? (
                    <div className='bg-white overflow-y-scroll no-scrollbar overfow-hidden'
                      style={{ width: "50%", float: "left",height: elementsSize }}
                      onMouseOver={() =>
                        handleSubCategoriesOver(
